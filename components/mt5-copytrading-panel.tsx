...
type Account = MonitorAccount & { canEditServer?:boolean;id:string;label:string;role:"master"|"slave";account:string;server:string;mode:string;online:boolean;enabled:boolean;equity:number;positionCount:number;managedCopies:number;queuedCopies?:number;copyIssues?:{source:string;symbol:string;message:string}[];error:string;pending:{id:string;symbol:string;volume:number}|null };
